...
c---------------------------------------------------------------------
   ...
   80       format('  iter ',i3)
         ...
         call dummy_gen_pim_begin
         call mg3P(u,v,r,a,c,n1,n2,n3,k)
         call dummy_gen_pim_end
...
c---------------------------------------------------------------------
c Set dummy function for PIN tool
c---------------------------------------------------------------------
      subroutine dummy_fixed_pim_begin
      write(*,*), "dummy_fixed_pim_begin"
      return
      end

      subroutine dummy_fixed_pim_end
      write(*,*), "dummy_fixed_pim_end"
      return
      end 

      subroutine dummy_gen_pim_begin
      write(*,*), "dummy_gen_pim_begin"
      return
      end

      subroutine dummy_gen_pim_end
      write(*,*), "dummy_gen_pim_end"
      return
      end
